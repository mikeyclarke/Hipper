...
final class TopicModel implements KnowledgebaseContentModelInterface
{
    use ModelTrait;
    ...
    private $urlSlug;
    private $urlId;
    private $parentTopicId;
    private $knowledgebaseId;
    private $organizationId;
    private $created;
    private $updated;

    public static function createFromArray(array $array): TopicModel
    {
        $model = new static;
    ...
    public function setParentTopicId(?string $parentTopicId): void
    {
        $this->parentTopicId = $parentTopicId;
    }

    public function getParentTopicId(): ?string
    {
